...
#define VISITORS(visitor_type) VISITOR(program, visitor_type); VISITOR(node_list, visitor_type); VISITOR(function_definition, visitor_type); VISITOR(variable_definition, visitor_type); VISITOR(identifier, visitor_type); VISITOR(integer, visitor_type); VISITOR(function_call, visitor_type); VISITOR(unary_expression, visitor_type); VISITOR(binary_expression, visitor_type); VISITOR(labeled_expression, visitor_type); VISITOR(jump_expression, visitor_type); VISITOR(variable_assignment, visitor_type)
